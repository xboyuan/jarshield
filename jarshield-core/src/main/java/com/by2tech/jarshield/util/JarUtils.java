...
public class JarUtils {
    ...
    public static String getRootPath(String path) {
        ...
        // example: jar:nested:/D:/app/fat.jar/!BOOT-INF/classes/!/jnpf/Foo.class
        // after `jar:` strip => nested:/D:/app/fat.jar/!BOOT-INF/classes/!/jnpf/Foo.class
        ...
        // Spring Boot 3.2+ nested JAR: separator is "/!" (slash-bang)
        // /D:/app/fat.jar/!BOOT-INF/classes/!/...   -> /D:/app/fat.jar
        // /D:/app/fat.jar/!BOOT-INF/lib/foo.jar/!.. -> /D:/app/fat.jar
        else if (path.contains("/!")) {
            return path.substring(0, path.indexOf("/!"));
        }
        //jar (Spring Boot 2.x style: separator "!/")
        else if (path.contains("!")) {
            return path.substring(0, path.indexOf("!"));
        }
        //普通jar/war
